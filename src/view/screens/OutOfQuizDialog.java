		...
		getContentPane().setLayout(null);
			...
			btnOk.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					if(quizScreen.getStateFromWhereTheOutOfQuizDialog()==StateFromWhereTheOutOfQuizDialog.ALL_OTHER_STATMENT) {
					quizController.removeQuizFromDb();	
					quizController.goToSelectedScreen(quizScreen.selectedLblPanelBar);
					}
					else if (quizScreen.getStateFromWhereTheOutOfQuizDialog()==StateFromWhereTheOutOfQuizDialog.LOG_OUT_STATMENT) {
						quizController.removeQuizFromDb();
						quizController.logOut();
					}
					
					else if(quizScreen.getStateFromWhereTheOutOfQuizDialog()==StateFromWhereTheOutOfQuizDialog.EXIT_STATMENT) {
						quizController.removeQuizFromDb();
						quizScreen.dispose();
					}

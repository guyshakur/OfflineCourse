...
public class SolvedQuizScreen extends JFrame {
		...
		btnNext.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(null, "Failed to display next question. "+e1.getMessage(), "ERROR",JOptionPane.ERROR_MESSAGE);
				}
	...
	public void displayOptionalAnswer(int answerIndex,String text) {
		...
		default:
			JOptionPane.showMessageDialog(null, "invalid answer number: "+answerIndex, "ERROR", JOptionPane.ERROR_MESSAGE);
			break;
		}
	...
	public void displayQuizSummary(int grade, int numOfQuestions, int numOfQuestionAnswerdRight) {
		...
		String summary="Your grade is: " +grade+ "\nYou got "+numOfQuestionAnswerdRight+" of "+numOfQuestions+" answerd right!";
